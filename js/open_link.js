    	function search(sender) {
	     	...
	     	switch(sender.id){
	     		...
	     		break;
	     		case '360so':
	     			window.open('https://www.so.com/s?q=' + o.value)
	     		break;
	     		case 'sinaweibo':
	     		...
	     		break;
	     		case 'typekit':
	     			window.open('https://typekit.com/search?utf8=âœ?q=' + o.value);
	     		break;
	     		case 'artsy':
	     		...
	     		break;
	     		case 'designernews':
	     			window.open('https://news.layervault.com/search?utf8=âœ?query=' + o.value);
	     		break;
	     		case 'torrentsto':
	     		...
	     		break;
	     		case 'cocoacontrols':
	     			window.open('https://www.cocoacontrols.com/search?utf8=âœ?q=' + o.value);
	     		break;
	     		case 'cocoachina':
